...
FROM python:3.13.3-slim as deps
...
ENV NAME microcosm_resourcesync
...
ARG BUILD_NUM
ARG SHA1
ENV MICROCOSM_RESOURCESYNC__BUILD_INFO_CONVENTION__BUILD_NUM ${BUILD_NUM}
ENV MICROCOSM_RESOURCESYNC__BUILD_INFO_CONVENTION__SHA1 ${SHA1}
COPY $NAME /src/$NAME/
